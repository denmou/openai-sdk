...
@Data
@Builder
public class AudioTranslationsRequest implements OpenAiRequest {
    /**
     ...
     * The <a href="https://platform.openai.com/docs/guides/speech-to-text/prompting">prompt</a> should be in English.
     **/
